...
function myTest() {
    ...
    d3.json("http://localhost:4200/assets/flare1.json", function(data) {
        ...
        var childEnterTransition = childrenCells.enter()
            ...
            .on("click", function(d) {
                zoom(treemap,node === d.parent ? root : d.parent);
            });
        childEnterTransition.append("rect")
            .classed("background", true)
            .style("fill", function(d) {
                return color(d.parent.namep);
            });
    ...
    function zoom(treemap,d) {
      treemap
                ...
                if (!i && (level !== self.root)) {
                    chart.selectAll(".cell.child")
                        ...
                        .style("color", function(d) {
                            return idealTextColor(color(d.parent.namep));
                        });
        ...
        zoomTransition.select("rect")
            ...
            .style("fill", function(d) {
                return d.children ? headerColor : color(d.parent.namep);
            });
